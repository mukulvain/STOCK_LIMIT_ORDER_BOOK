...
urlpatterns = [
    path(
        "",
        auth_views.LoginView.as_view(template_name="trading/login.html"),
        name="login",
    ),
    ...
    path(
        "orderbook/get_recent_trades/",
        views.get_recent_trades,
    ...
    path(
        "modify_order/update_prev_order/",
        views.update_prev_order,
        name="update_prev_order",
    ),
    path("cancel_order/", views.cancel_order, name="cancel_order"),
    path(
        "cancel_stoploss_order/",
        views.cancel_stoploss_order,
